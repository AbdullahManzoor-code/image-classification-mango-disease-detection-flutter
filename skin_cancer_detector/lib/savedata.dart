...
Future<void> storeData(String imageUrl, String username, String email,String result, String suggestion ) async {
  try {
  ...
  'username': username,
  'email': email,
  'Result': result,  // Size selected by the user
  'suggestion': suggestion,      // Actual size details
